...
public class AutoShutdownGUI extends javax.swing.JFrame {
    ...
    private static final Color FONT = new Color(73, 79, 91);
    ...
    public AutoShutdownGUI() throws IOException, AWTException {
        ...
        // Here we set the colour of the text in the labels to be the same colour as the background
        // in order to keep the size of the label to get the spacing of the other GUI components right
        // and not have the placeholder text be visible
        lblEvent1.setForeground(BACKGROUND);
        lblEventsTitle.setForeground(BACKGROUND);
    ...
    private void initComponents() {
        ...
        lblDialogMsg.setText("Lorem ipsum");
        lblDialogMsg.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        lblDialogMsg.setMaximumSize(new java.awt.Dimension(81, 50));

        javax.swing.GroupLayout pnlGeneralDlgTextLayout = new javax.swing.GroupLayout(pnlGeneralDlgText);
        pnlGeneralDlgText.setLayout(pnlGeneralDlgTextLayout);
        pnlGeneralDlgTextLayout.setHorizontalGroup(
            pnlGeneralDlgTextLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlGeneralDlgTextLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlGeneralDlgTextLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblDialogTitle)
                    .addComponent(lblDialogMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(67, Short.MAX_VALUE))
        );
        pnlGeneralDlgTextLayout.setVerticalGroup(
            pnlGeneralDlgTextLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlGeneralDlgTextLayout.createSequentialGroup()
                .addGap(47, 47, 47)
                .addComponent(lblDialogTitle)
                .addGap(5, 5, 5)
                .addComponent(lblDialogMsg, javax.swing.GroupLayout.DEFAULT_SIZE, 92, Short.MAX_VALUE)
                .addGap(45, 45, 45))
        );
        ...
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.insets = new java.awt.Insets(6, 0, 16, 0);
        ...
        lblUpdatedDate.setText("23/07/2025");
        ...
        lblEventsTitle.setText("Upcoming Events (Stage 8):");
    ...
    private static void openHelpDoc() {
        extractDocsIfMissing();
        try {
            Desktop.getDesktop().browse(Paths.get("docs/help.html").toAbsolutePath().toUri());
        } catch (IOException e) {
            logger.log(e);
            CustomDialogManager.showDialog("Error", "Failed to open help document",
                    "An error occurred while trying to open the help document.", CustomDialogManager.MSG_ERR);
        }

    }

    private static void extractDocsIfMissing() {
        String[] filesToExtract = { "help.html", "interface.png" }; // List your resource filenames here
        ...
        try {
            ...
            for (String fileName : filesToExtract) {
                ...
                if (Files.notExists(outputFile)) {
                    try (InputStream in = AutoShutdownGUI.class.getResourceAsStream("/resources/docs/" + fileName)) {
                        if (in == null) {
                            System.err.println("Resource not found in JAR: " + fileName);
                            continue;
                        }
    ...
    private void cmbTimeSelectorActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmbTimeSelectorActionPerformed
        ...
        if (selectedIndex == lastInList) {
            ...
            while (true) {
                String input = CustomDialogManager.showInputDialog("Enter time (minutes)");
                if (input.isBlank()) {
                    ...
                    CustomDialogManager.showDialog("Error", "Invalid Integer", "The value you entered is invalid",
    ...
    private void btnApplySettingsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnApplySettingsActionPerformed
        ...
        try {
            ...
            logger.log(e);
            CustomDialogManager.showDialog("Error", "Unsupported OS",
            ...
            try {
                ...
                if (!json.has("error")) {
                    ...
                    if (areaID != null && areaName != null) {
                        ...
                        CustomDialogManager.showDialog("An error occurred", "Error",
                    ...
                    CustomDialogManager.showDialog("An error occurred", "Error " + json.getInt("error"),
    ...
    private void btnAreaSelectorMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_btnAreaSelectorMouseClicked
        ...
        try {
            int responseCode = api.getStatus();
            switch (responseCode) {
                case 200, 429:
                    tokenValid = true;
                    break;
            ...
            CustomDialogManager.showDialog("API Error", "API Response Timed Out",
                    "API unresponsive, please try again later",
                    CustomDialogManager.MSG_ERR, true);
        }

        while (!tokenValid) {
            dlgInsertToken.setLocation(p);
            dlgInsertToken.setEnabled(true);
            ...
            if (!token.isBlank()) {
                try {
                    ...
                    switch (responseCode) {
                        case 200, 429:
                            ...
                            break;
                        default:
                            CustomDialogManager.showDialog("API Error", "Error " + responseCode,
                                    HTTP.get(responseCode), CustomDialogManager.MSG_ERR);
                            break;
                    }
                ...
                CustomDialogManager.showDialog("Error", "No Token Entered",
                        "You must enter a valid token to continue",
                        CustomDialogManager.MSG_ERR);
            }
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new CustomDialogManager().setVisible(true);
                guiInitialized = true;
            } catch (IOException | AWTException e) {
                logger.log("Error initializing GUI", e);
                CustomDialogManager.showDialog("Initialization Error", "Error",
        ...
        if (ShutdownUtils.getOS() == -1) {
            ...
            CustomDialogManager.showDialog("Unsuported operating system", "System Error",
        ...
        if (apiStatus != 200) {
            if (apiStatus != 403) {
                CustomDialogManager.showDialog("API Status", "API Status", apiStatus + " - " + HTTP.get(apiStatus),
                        CustomDialogManager.MSG_ERR,
                        6000);
                tokenValid = true;
            }
        ...
        while (true) {
            while (!btnKillSwitch.isSelected()) {
                ...
                if (nextShutdown <= 300 && nextShutdown > 285 && !fiveMinuteWarning) {
    ...
    private static void getScheduleAndUpdateGUI()
        ...
        if (!schedule.has("error")) {
            ...
            CustomDialogManager.showDialog("API Status", "API Status", error + " - " + HTTP.get(error),
    ...
    protected static javax.swing.JDialog dlgGeneral;
    protected static javax.swing.JDialog dlgInputDialog;
    ...
    protected static javax.swing.JLabel lblDialogImg;
    protected static javax.swing.JLabel lblDialogMsg;
    protected static javax.swing.JLabel lblDialogTitle;
    ...
    protected static javax.swing.JLabel lblInputHeading;
    ...
    protected static javax.swing.JTextField txfInputDialog;
